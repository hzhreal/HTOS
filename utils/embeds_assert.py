...
from utils.embeds import (
    ...
    embconvCompleted, embSceSys, embgs, embc, embCRdone,
...
_MAP_PLACEHOLDER = {
    ...
    emb_conv_choice: {("title", frozenset({"basename"})), ("description", frozenset({"j", "entry_count", "i", "batches"}))},
    embCDone1: set(),
    embCDone2: set(),
    embCDone3: {("description", frozenset({"result", "basename", "j", "entry_count", "i", "batches"}))},
    ...
    embLoading: {("description", frozenset({"basename", "j", "entry_count", "i", "batches"}))},
    embApplied: {("description", frozenset({"basename", "j", "entry_count", "i", "batches"}))},
