...
from data.crypto import Crypt_Rstar, Crypt_Rev2, Crypt_BL3, Crypt_DI2, Crypt_DL, Crypt_MGSV, Crypt_Ndog, Crypt_RGG, Crypt_Xeno2, Crypt_NMS
...
Crypto = SimpleNamespace(
    ...
    DL=Crypt_DL, RGG=Crypt_RGG, DI2=Crypt_DI2, NMS=Crypt_NMS
)