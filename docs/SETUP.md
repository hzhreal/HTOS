...
> [!CAUTION] 
> HTOS will attempt to delete all files that exist in the authenticated Google Drive account. Because of this, it is recommended to use a Google Drive account that does not contain any personal files that you don't want to be deleted. 
